          ...
          <div className="space-y-4 py-4">
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>{job.backend}</div>
               ...
               <div className="font-medium text-muted-foreground">Qubits Used</div>
              <div>{job.qubit_count}</div>
              ...
              <div>{job.elapsed_time ? job.elapsed_time.toFixed(2) : 'N/A'} seconds</div>
              
              <div className="font-medium text-muted-foreground">QPU Time</div>
              <div>{job.qpu_seconds ? job.qpu_seconds.toFixed(2) : 'N/A'} seconds</div>
            </div>
            ...
            <div>
              ...
              <pre className="font-code overflow-x-auto rounded-md bg-muted p-2 text-xs">
                <code>{job.results && Object.keys(job.results).length > 0 ? JSON.stringify(job.results, null, 2) : "No results available."}</code>
              </pre>
            </div>
          </div>
        </ScrollArea>
